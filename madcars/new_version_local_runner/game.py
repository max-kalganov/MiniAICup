...
class Game(object):
    ...
    def save_visio(self):
        ...
        with open('/home/mr_neither/Work/PycharmProjects/MiniAICup/visio', 'w') as f:
            f.write(json.dumps(d))
        return {
            "filename": os.path.basename('/home/mr_neither/Work/PycharmProjects/MiniAICup/visio'),
            "location": '/home/mr_neither/Work/PycharmProjects/MiniAICup/visio',
            "is_private": False
        }
